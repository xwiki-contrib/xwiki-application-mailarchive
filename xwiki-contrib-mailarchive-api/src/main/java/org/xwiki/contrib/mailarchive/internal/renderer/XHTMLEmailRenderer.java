...
public class XHTMLEmailRenderer extends AbstractChainingPrintRenderer implements Initializable
{
    /**
    ...
    public void initialize() throws InitializationException
    {
        ...
        chain.addListener(new XHTMLEmailChainingRenderer(this.linkRenderer, this.imageRenderer, chain));
    }
}
