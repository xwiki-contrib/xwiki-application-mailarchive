...
import org.xwiki.component.mailarchive.internal.MailUtils;
...
public class MessagesThreader
{
    ...
    public ThreadableMessage thread(List<ThreadableMessage> messages) throws Exception
    {
        ...
        if (root.next != null)
            throw new MailArchiveException("root node has a next?" + root);
     ...
     * @return
     */
    public Container findRoot(HashMap<String, Container> id_table)
    {
    ...
    public void pruneEmptyContainers(Container root)
    {
